...
namespace Core
{
    public static class Extentions
    {
        ...
        {
            return price <= balance.Value && balance.Value > 0;
        }
        ...
        {
            var businessStaticData = staticDataService.ForBusiness(businessCard.BusinessTypeId);
        ...
        {
            return powerUp.IncomeMultiplyerPercent / 100f;
        }
