...
namespace Systems
{
    public sealed class SaveGameSystem : IEcsInitSystem, IEcsRunSystem
    {
        ...
        private void SaveProgress()
        {
            ...
            progress.BalanceData.Value = _factory.Balance.Value;
        ...
        private List<BusinessCardData> GetBusinessCardDataList()
        {
            ...
            foreach (var businessCardIndex in _businessCardFilter)
            {
                ...
                businessCardData.Id = businessCard.BusinessTypeId;
                ...
                if (_incomeTimerPool.Has(businessCardIndex))
                {
                    ref var incomeTimer = ref _incomeTimerPool.Get(businessCardIndex);
                    businessCardData.IncomeTimerState = incomeTimer.Timer;
                }
                else
                {
                    businessCardData.IncomeTimerState = businessCard.IncomeDelay;
                }
        ...
        private List<PowerUpData> GetPowerUpDataList(BusinessCard businessCard)
        {
            ...
            foreach (var entityWithWorld in businessCard.PowerUps)
            {
                ...
                powerUpData.BusinessId = powerUp.BusinessTypeId;
